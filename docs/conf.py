...
firm_info_version = "0.3.0"


# -- Project information -----------------------------------------------------

now = datetime.date.today()
project = 'django-firm-info'
copyright = "2023-{}, Emencia".format(now.year)
author = 'Philippe Lafaye'

# The short X.Y version
version = firm_info_version
# The full version, including alpha/beta/rc tags
release = firm_info_version
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/emencia/django-firm-info/",
